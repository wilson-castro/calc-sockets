// Módulo separado para ferramentas de desenvolvimento. Fica fora do go.mod
// principal para que as dependências do Task não entrem na calculadora.
module calcsockets/tools
